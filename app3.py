...
if "faiss_index" not in st.session_state:
    ...
    st.session_state.file_processed = False  # NEW: Track file processing state
...
# --- FIXED: HANDLE FILE UPLOAD FIRST ---
# This ensures file processing happens BEFORE chat input
...
if uploaded_file is not None:
    ...
    # Check if this is a new file that hasn't been processed
...
# --- HANDLE TEXT CHAT INPUT (only if no file was processed this run) ---
if not file_processed_this_run:
    if prompt := st.chat_input("Ask about your prescriptions or medications..."):
        # Only process chat input if we're not currently processing a file
